    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-6">
      <div className="max-w-md w-full text-center">
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">Event Error</h1>
          <p className="text-zinc-400">
            {error.message || "Failed to load this event. It may have been deleted or you don't have access."}
          </p>
        </div>
